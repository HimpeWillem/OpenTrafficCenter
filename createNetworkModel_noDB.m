function [nodes_net,links_net,origins,destinations,detectors_net,data,lmain,lorg] = createNetworkModel_noDB(nodes,links,detectors,str_point,end_point,int_point,str_time,end_time)
...
[temp1, par,temp2] = dijkstra_v2(rp,ci,ai,str_point);
...
[data] = collectData_noDB(data_links,detectors,str_time,end_time);
